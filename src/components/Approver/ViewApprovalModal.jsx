import { X, Download, FileText, User, Calendar, MessageSquare, CheckCircle, XCircle, Clock } from 'lucide-react';
import { useState } from 'react';
import axios from 'axios';

export default function ViewApprovalModal({ doc, onClose, onUpload }) {
  ...
  const handleAction = async (actionType) => {
    try {
      ...
      const response = await axios.put(
        `http://localhost:9191/approve/${doc.id}/action`,
        {},
        {
      ...
      console.log(response.data || 'Action completed successfully!');
      console.log("called");
      onClose();
              ...
              {doc.approvedBy && (
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{ color: '#555556ff', marginBottom: '4px' }}>
                      {doc.approvedBy || 'N/A'}
                    </div>
            ...
            {isPendingApproval ? (
              <>
                <button
                  ...
                  onMouseEnter={(e) => {
                    if (!isLoading) e.currentTarget.style.backgroundColor = '#FEE2E2';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.backgroundColor = 'white';
                  }}
