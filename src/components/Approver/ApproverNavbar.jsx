  ...
  return (
   <>
       <div className="navbar" style={{
                ...
                <div style={{
                    marginLeft: '130px', fontWeight: 'bold', fontSize: '20px', color: '#000000ff',
                }}>
                    <div>

                        <p style={{ marginBottom: '-25px' ,fontSize:'23px', marginTop:'10px' }}>DocuFlow</p>
                        <div>
                            <p style={{ fontSize: '20px', fontWeight: 'normal', color: '#6B7280', display: 'flex', justifyContent: 'center',fontFamily:'Pacifico' }}>
                                {user.username}
                            </p>
                        </div>
                    </div>
